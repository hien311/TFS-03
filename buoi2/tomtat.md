...
### MixedCaps
- Trong Go thì sử dụng một quy tắc có tên gọi là mixedCaps (thường được gọi là camelCase) thay vì gạch dướng để viết tên nhiều từ. Quy tắc đó là chữ cái đầu sẽ viết thường, sau đó những chữ cái đầu tiên của mỗi từ sau đó sẽ được viết hoa. Nếu muốn sử dựng một hàm hay biến ở ngoài package, ký tự đầu tiên của  nó phải là chữ viết hoa.
### Interface names
...
### getters 
- Việc tự cung cấp getters và setters là được phép nhưng không cần thiết và không được khuyến khích
## Quy tắc chưa được viết trong Go
**_Có những quy tắc không được viết ra nhưng nó lại phổ biến trong cộng đồng 
